"""
Command to run: run "python runner.py --capacity {capacity, choices = [5, 10, 20]}"

    Runs all the nodes in the network. 5|10 nodes
...
def run_node(port, nodes, capacity):
    ...
    venv_command = "source .venv/bin/activate" #command that activates python virtual environment
...
if __name__ == "__main__":
    ...
    nodes = len(node_ports) #total no. of nodes
